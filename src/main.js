...
async function init() {
  ...
  const boundBox1 = roomInstance1.createBoundBoxes();
  ...
  const boundBox2 = roomInstance2.createBoundBoxes();
  ...
  const boundBox3 = roomInstance3.createBoundBoxes();
  ...
  const boundBox4 = roomInstance4.createBoundBoxes();
  ...
  const boundBox5 = roomInstance5.createBoundBoxes();
  ...
  const boundBox6 = roomInstance6.createBoundBoxes();
  ...
  const boundBox7 = roomInstance7.createBoundBoxes();
  ...
  const boundBox8 = roomInstance8.createBoundBoxes();
  ...
  const boundBox9 = roomInstance9.createBoundBoxes();
  ...
  const boundBox10 = roomInstance10.createBoundBoxes();
  ...
  const boundBox11 = roomInstance11.createBoundBoxes();
  ...
  const boundBox12 = roomInstance12.createBoundBoxes();
  ...
  const boundBox13 = roomInstance13.createBoundBoxes();
  ...
  const boundBox14 = roomInstance14.createBoundBoxes();
  ...
  const boundBox15 = roomInstance15.createBoundBoxes();
  ...
  const boundBox16 = roomInstance16.createBoundBoxes();
